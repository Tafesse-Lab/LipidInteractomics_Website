...
data <- readr::read_csv(here("IndividualStudies/DataTables/SF_ACS-Chem-Bio_2024_download.csv"))
...
datatable(data_reactive, 
          options = list(pageLength = 15),
                         colnames = c("Gene Name","Protein ID/Accession", "Lipid Probe", "Hit Annotation", "LogFC", "p value", "Average Expression", "FDR"))

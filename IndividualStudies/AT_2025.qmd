...
# CC_enrichment_plots(AT_2025_Long, "dot", "PE-PA_AT_2025_CC-DOTplot")
# CC_enrichment_plots(AT_2025_Long, "cnet", "PE-PA_AT_2025_CC-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# MF_enrichment_plots(AT_2025_Long, "dot", "PE-PA_AT_2025_MF-DOTplot")
# MF_enrichment_plots(AT_2025_Long, "cnet", "PE-PA_AT_2025_MF-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# BP_enrichment_plots(AT_2025_Long, "dot", "PE-PA_AT_2025_BP-DOTplot")
# BP_enrichment_plots(AT_2025_Long, "cnet", "PE-PA_AT_2025_BP-CNETplot")
```

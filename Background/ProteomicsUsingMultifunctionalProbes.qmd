...
- Irradiation with 355 nm wavelength light ()
...
- Affinity purification of probe-conjugated proteins
  ...
  * Conjugates of protein-lipid-bead are covalently bound and can thus be stringently washed with detergent solutions to remove non-specific proteins. Detergent can then be removed with repeated washes of 8 M urea and 20 % acetonitrile. 
* Captured proteins can be reduced and alkylated on-bead. 
* Peptides can be digested off the protein-lipid-bead conjugates via tryptic digest. Digested peptides are then desalted to remove any remaining contaminants using reverse phase desalting columns.

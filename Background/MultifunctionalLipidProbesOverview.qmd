...
* Quantification of +UV versus -UV
  - The details of the quantitative mass spectrometry are describe in our [Overview of Proteomics Methods](Background/ProteomicsUsingMultifunctionalProbes.qmd), however, we hope to succinctly describe that quantitative mass spectrometry techniques necessarily require normalization at sample input level -- thereby exaggerating the abundance of proteins in the -UV control samples. 

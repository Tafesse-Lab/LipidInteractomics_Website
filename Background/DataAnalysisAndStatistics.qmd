...
The datasets incorporated into the [Probe vs Probe Comparison](https://lipidinteractome.org/lipidprobe/enrichedhitscomparison) tool each consist of normalized ratiometric data of fundamentally similar form, with qualitatively comparable statistical annotations. 

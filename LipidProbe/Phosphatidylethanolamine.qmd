...
![(A) Native Phosphatidylethanolamine.](/LipidProbe/Structures/PE.png)

![(B) Trifunctional Phosphatidylethanolamine.](/LipidProbe/Structures/TF_PE.png)
...
data <- readr::read_csv(here("LipidProbe/DataSets/PE_membrane_HeLa_AT_2025.csv"))
...
:::{.border}
```{r, echo=FALSE, warning=FALSE}
#| fig-cap: "Data as reported in [Thomas et al., 2025](/IndividualStudies/AT_2025.qmd). Ranked-order plots depict the relative enrichment of each protein versus non-crosslinked control (y-axis) from lowest to highest. Black proteins are unenriched or depleted in the presence of probe, Purple enriched candidates are defined as proteins with a false discovery rate less than 0.2 and a fold change of at least 1.5-fold, and Orange enriched hits are defined as proteins with a false discovery rate less than 0.05 and a fold change of at least 2-fold in the +UV over the -UV."
...
# Slight cleanup for presenting in the datatable
data <- data |>
...
datatable(data_reactive, 
          ...
          colnames = c("Rank", "Gene Name", "Accession #", "Lipid Probe", "Fraction", "LogFC", "AveExpr", "p value", "Hit Annotation"))            
...
{{< downloadthis DataSets/PE_membrane_HeLa_AT_2025.csv dname="PE_membrane_HeLa_AT_ChemComm_download">}}
...
# Read the membrane data to a df
data <- readr::read_csv(here("LipidProbe/DataSets/PE_cytosol_HeLa_AT_2025.csv"))
...
{{< downloadthis DataSets/PE_cytosol_HeLa_AT_2025.csv dname="PE_cytosol_HeLa_AT_ChemComm_download">}}

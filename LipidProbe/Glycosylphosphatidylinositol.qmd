...
data <- data |>
  dplyr::select(gene_name, Accession, hit_annotation, logFC, pvalue) |>
...
datatable(data_reactive, 
          ...
          colnames = c("Rank", "Gene Name", "Accession #", "Hit Annotation", "LogFC", "p value"))              
...
{{< downloadthis DataSets/bf-GPI_SK_2024_ChemEuro.csv dname="bf-GPI_SK_2024_ChemEuro">}}

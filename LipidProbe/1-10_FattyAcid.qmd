...
SF_2024_data <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/1-10_FA_Huh7_SF_2024.csv")) |>
	filter(LipidProbe == "1-10 FA")
...
# CC_enrichment_plots(SF_2024_data, "dot", "/LipidProbe/GO_plots/1-10FA_SF_2024_CC-DOTplot")
# CC_enrichment_plots(SF_2024_data, "cnet", "/LipidProbe/GO_plots/1-10FA_SF_2024_CC-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# MF_enrichment_plots(SF_2024_data, "dot", "/LipidProbe/GO_plots/1-10FA_SF_2024_MF-DOTplot")
# MF_enrichment_plots(SF_2024_data, "cnet", "/LipidProbe/GO_plots/1-10FA_SF_2024_MF-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# BP_enrichment_plots(SF_2024_data, "dot", "/LipidProbe/GO_plots/1-10FA_SF_2024_BP-DOTplot")
# BP_enrichment_plots(SF_2024_data, "cnet", "/LipidProbe/GO_plots/1-10FA_SF_2024_BP-CNETplot")
```

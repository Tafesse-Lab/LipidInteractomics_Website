...
:::{.border}
::: {layout="[[100], [100]]"}
![(A) Native Sphingosine.](/LipidProbe/Structures/Sphingosine.png)

![(B) Trifunctional Sphingosine.](/LipidProbe/Structures/TF_Sphingosine.png)
...
data <- data |>
  dplyr::select(gene_name, protein_id, hit_annotation, logFC, pvalue, fdr) |>
...
datatable(data_reactive, 
          options = list(pageLength = 10),
                         colnames = c("Rank", "Gene Name", "Accession #", "Hit Annotation", "LogFC", "p value", "FDR"))

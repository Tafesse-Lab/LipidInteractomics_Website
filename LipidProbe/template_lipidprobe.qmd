...
<!-- CHANGE THIS TO THE CORRECT DOT PLOT, RENDERED VIA FUNCTIONS CALLED IN Resources/Run_GO_DOTplots.R -->
<iframe src="/LipidProbe/GO_plots/Sph_SF_2024_CC-DOTplot.html" width="100%" height="500px"></iframe>

#### Molecular Function

<!-- CHANGE THESE IF THE MF AND BP DOT PLOTS WORK PROPERLY -->
...
<!-- CHANGE THIS TO THE CORRECT NEW DATASET -->

...
:::{.border}
![](/LipidProbe/Structures/PhosphatidicAcid_Structure.png)
:::
...
# write.csv(AT_2025_Long, "LipidProbe/DataSets/PA_HeLa_AT_2025.csv")


AT_2025_Long <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/PA_HeLa_AT_2025.csv")) 
...
# CC_enrichment_plots(AT_2025_Long, "dot", "/LipidProbe/GO_plots/PA_AT_2025_CC-DOTplot")
# CC_enrichment_plots(AT_2025_Long, "cnet", "/LipidProbe/GO_plots/PA_AT_2025_CC-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# MF_enrichment_plots(AT_2025_Long, "dot", "/LipidProbe/GO_plots/PA_AT_2025_MF-DOTplot")
# MF_enrichment_plots(AT_2025_Long, "cnet", "/LipidProbe/GO_plots/PA_AT_2025_MF-CNETplot")
```
...
```{r, echo=FALSE, warning=FALSE}
#### These functions make the plots to be displayed in this div - uncomment them to run them again
# BP_enrichment_plots(AT_2025_Long, "dot", "/LipidProbe/GO_plots/PA_AT_2025_BP-DOTplot")
# BP_enrichment_plots(AT_2025_Long, "cnet", "/LipidProbe/GO_plots/PA_AT_2025_BP-CNETplot")
```
...
{{< downloadthis DataSets/PA_HeLa_AT_2025.csv dname="PA_HeLa_AT_ChemComm_download.csv">}}

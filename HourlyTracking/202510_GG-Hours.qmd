...
subtitle: Invoice Number 20251001
...
header-includes:
  ...
  - "\\fancyhead[R]{2025 10 31}"
  - "\\fancyhead[R]{Invoice Number 20251001}"
  - "\\fancyfoot{}"
...
Please find below the hours I logged for the month of October 2025, with descriptions of each day's activity. In total, I performed 2 hours of work at an hourly rate of $50 (USD), for a total bill of $100. 
...
hours_data <- read_csv(here("HourlyTracking/hours.csv"), col_names = c("Date", "Hours", "Activity"), show_col_types = FALSE) |>
  ...
  filter(Date >= as.Date("2025-10-01") & Date < as.Date("2025-11-01")) %>%  # Filter for April 2025
  glimpse()

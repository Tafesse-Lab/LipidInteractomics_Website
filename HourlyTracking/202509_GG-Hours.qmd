---
title: Lipid Interactome Monthly Invoice
subtitle: Invoice Number 20250901
...
header-includes:
  ...
  - "\\fancyhead[R]{2025 09 04}"
  - "\\fancyhead[R]{Invoice Number 20250901}"
  - "\\fancyfoot{}"
...
Please find below the hours I logged for the month of September 2025, with descriptions of each day's activity. In total, I performed 5 hours of work at an hourly rate of $50 (USD), for a total bill of $250. 
...
hours_data <- read_csv(here("HourlyTracking/hours.csv"), col_names = c("Date", "Hours", "Activity"), show_col_types = FALSE) |>
  ...
  filter(Date >= as.Date("2025-09-01") & Date < as.Date("2025-10-01")) %>%  # Filter for April 2025
  glimpse()

...
Sph_data <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/Sph_Huh7_SF_2024.csv")) |>
	filter(LipidProbe == "Sph") |> as.data.table()
...
PE_membrane_AT_2025 <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/PE_membrane_HeLa_AT_2025.csv"))
PE_cytosol_AT_2025 <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/PE_cytosol_HeLa_AT_2025.csv"))

PE_AT_2025 <- rbindlist(list(PE_membrane_AT_2025, PE_cytosol_AT_2025))
...
PA_membrane_AT_2025 <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/PA_membrane_HeLa_AT_2025.csv"))
PA_cytosol_AT_2025 <- readr::read_csv(paste0(here(), "/LipidProbe/DataSets/PA_cytosol_HeLa_AT_2025.csv"))

PA_AT_2025 <- rbindlist(list(PA_membrane_AT_2025, PA_cytosol_AT_2025))
...
AT_2025_membrane <- readr::read_csv(paste0(here(), "/IndividualStudies/DataTables/AT_ChemicalCommunications_2025_membrane_download.csv")) 
AT_2025_cytosol <- readr::read_csv(paste0(here(), "/IndividualStudies/DataTables/AT_ChemicalCommunications_2025_cytosol_download.csv")) 

AT_2025 <- rbindlist(list(AT_2025_membrane, AT_2025_cytosol))
...
DCC_2025 <- readr::read_csv(paste0(here(), "/IndividualStudies/DataTables/DataWrangling/DCC_2025_ChemrXiv_FilteredDataset.csv")) |>
  group_by(gene_name) |>
...
CC_enrichment_plots(DCC_2025, "cnet", "NAPE_DCC_2025_CC-CNETplot")

MF_enrichment_plots(DCC_2025, "dot", "NAPE_DCC_2025_MF-DOTplot")
MF_enrichment_plots(DCC_2025, "cnet", "NAPE_DCC_2025_MF-CNETplot")

BP_enrichment_plots(DCC_2025, "dot", "NAPE_DCC_2025_BP-DOTplot")
BP_enrichment_plots(DCC_2025, "cnet", "NAPE_DCC_2025_BP-CNETplot")
...
CC_enrichment_plots(WY_2021, "cnet", "/LipidProbe/GO_plots/PDAA_WY_2021_CC-CNETplot")

MF_enrichment_plots(WY_2021, "dot", "/LipidProbe/GO_plots/PDAA_WY_2021_MF-DOTplot")
MF_enrichment_plots(WY_2021, "cnet", "/LipidProbe/GO_plots/PDAA_WY_2021_MF-CNETplot")

BP_enrichment_plots(WY_2021, "dot", "/LipidProbe/GO_plots/PDAA_WY_2021_BP-DOTplot")
BP_enrichment_plots(WY_2021, "cnet", "/LipidProbe/GO_plots/PDAA_WY_2021_BP-CNETplot")

## SK_2024

SK_2024 <- read_csv(here("IndividualStudies/DataTables/SK_2024_ChemEuro.csv"))

CC_enrichment_plots(SK_2024, "dot", "/LipidProbe/GO_plots/bf-GPI_SK_2024_CC-DOTplot")
CC_enrichment_plots(SK_2024, "cnet", "/LipidProbe/GO_plots/bf-GPI_SK_2024_CC-CNETplot")

MF_enrichment_plots(SK_2024, "dot", "/LipidProbe/GO_plots/bf-GPI_SK_2024_MF-DOTplot")
MF_enrichment_plots(SK_2024, "cnet", "/LipidProbe/GO_plots/bf-GPI_SK_2024_MF-CNETplot")

BP_enrichment_plots(SK_2024, "dot", "/LipidProbe/GO_plots/bf-GPI_SK_2024_BP-DOTplot")
BP_enrichment_plots(SK_2024, "cnet", "/LipidProbe/GO_plots/bf-GPI_SK_2024_BP-CNETplot")

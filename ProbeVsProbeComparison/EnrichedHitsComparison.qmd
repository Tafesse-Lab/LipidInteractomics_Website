...
See our [Data Analysis & Statistics](https://lipidinteractome.org/background/dataanalysisandstatistics) background page for greater detail on the data alignment performed to enable this qualitative comparison.

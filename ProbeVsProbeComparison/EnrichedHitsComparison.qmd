...
See [@sec-DataAlignment] and [@sec-ProbevsProbeComparisonBackground] for greater detail on the data alignment performed to enable this qualitative comparison.

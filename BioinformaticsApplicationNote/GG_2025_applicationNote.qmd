...
-   Column descriptions:
    ...
    -   *Enrichment value*: Fold change of Experimental versus Control fold-change, typically log2-transformed -- ideally the product of TMT or other quantitative mass spectrometry methods.
    ...
    -   *FDR*: False-discovery rate of protein identification

...
authors:
  ...
  - name: "Frank Stein"
    affiliations:
      - name: "Proteomics Core Facility, European Molecular Biology Laboratory"
        city: Heidelberg
        country: Germany
        postal-code: 69117
  ...
  - name: Jeremy M. Baskin
    affiliations:
      - name: "Department of Chemistry and Chemical Biology and Weill Institute for Cell and Molecular Biology, Cornell University"
        city: Ithaca
        state: NY
        postal-code: 14853
...
Gaelen Guzman^1,^*, Frank Stein^2^, Jeremy M. Baskin^3^, Carsten Schulz^1^, Fikadu G. Tafesse^1^

^1^ = Departments of Molecular Immunology and Immunology and  Chemical Physiology and Biochemistry, Oregon Health & Science University, Portland, OR, USA; ^2^ = Proteomics Core Facility, European Molecular Biology Laboratory, Heidelberg, Germany; ^3^ = Department of Chemistry and Chemical Biology and Weill Institute for Cell and Molecular Biology, Cornell University, Ithaca, NY, USA; * = Corresponding author: <gaelen.guzman@lipidinteractome.org>
:::

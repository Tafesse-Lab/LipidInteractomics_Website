...
**We wish to emphasize that we will collaborate with data providers to prepare visualizations which best suit their datasets -- the example dataset above merely depicts an ideal case which allows for easy incorporation and cross-study comparison.**

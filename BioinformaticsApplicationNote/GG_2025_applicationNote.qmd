...
Gaelen Guzman^1,^*, Frank Stein^2^, Carsten Schulz^1^, Fikadu G. Tafesse^1^

^1^ = Oregon Health & Science University, Portland, OR, USA; ^2^ = European Molecular Biology Laboratory, Heidelberg, Germany * = Corresponding author: <gaelen.guzman@lipidinteractome.org>
:::
